...
import VisionSection from '@/components/v1/sections/VisionSection'
import DeveloppementSection from '@/components/v1/sections/DeveloppementSection'
import DirectionSection from '@/components/v1/sections/DirectionSection'
import PhilosophieSection from '@/components/v1/sections/PhilosophieSection'
import ProjetsSection from '@/components/v1/sections/ProjetsSection'
import CalendlySection from '@/components/v1/sections/CalendlySection'
import Footer from '@/components/v1/sections/Footer'
